        ...
        <div className="lg:col-span-4 lg:sticky lg:top-28 space-y-6">
          ...
          >
            ...
            <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-slate-800 border border-slate-700/50 mb-6">
              <div className="w-full h-full bg-[radial-gradient(circle_at_35%_25%,rgba(34,211,238,0.24),transparent_32%),linear-gradient(135deg,#020617,#0f172a_48%,#064e3b)] flex items-end justify-start p-6">
                <div className="font-mono text-xs text-cyan-100/80">
                  <div className="text-5xl font-bold tracking-tight text-white">FA</div>
                  <div className="mt-2 uppercase tracking-widest">Full-stack engineer</div>
                </div>
              </div>
              <div className="absolute bottom-3 right-3 bg-slate-950/80 backdrop-blur-md border border-emerald-500/30 px-3 py-1.5 rounded-full flex items-center gap-2">
